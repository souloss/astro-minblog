...
const PROMPTS: Record<string, PromptContent> = {
  zh: {
    identity: (authorName: string) =>
      `你是 ${authorName} 的博客 AI 助手，帮助读者发现感兴趣的内容、推荐文章和学习资源。`,
    responsibilities: [
  ...
  en: {
    identity: (authorName: string) =>
      `You are ${authorName}'s blog AI assistant, helping readers discover interesting content, recommend articles, and learning resources.`,
    responsibilities: [
